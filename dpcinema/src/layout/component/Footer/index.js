    ...
    return (
        <div className={cs('wrapper', className)}>
                ...
                <ul className={cs('list')}>
                    ...
                    <li className={cs('item')}>
                        <a href="" className={cs('item-link')}>
                            ...
                            Address: 482/15/5 Trưng Nữ Vương - Hải Châu - Đà Nẵng
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div className={cs('info', 'info_follow')}>
                ...
                <ul className={cs('list')}>
                    <li className={cs('item')}>
                        <a href="https://www.facebook.com/dinhhduc.2406" target="_blank" className={cs('item-link')}>
                    ...
                    <li className={cs('item')}>
                        <a href="https://www.instagram.com/dinhhduc246_" target="_blank" className={cs('item-link')}>
